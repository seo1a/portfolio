...
export default function AboutMe(){
    return(
        <section 
            className="min-h-screen bg-cover bg-center bg-no-repeat pt-[10vh] pb-[25vh]" 
            style={{ backgroundImage: `url(${backgroundImage})` }} 
        > 
            <h1 className="text-6xl text-center mb-[10vh]">About Me</h1> 
            <img src={profileImage} className="mx-auto w-[20vw] h-auto"/>
            <div className="text-center mt-[8vh] mx-[30vw]">
