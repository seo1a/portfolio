...
export default function AboutMe(){
    return(
        ...
        > 
            <h1 className='[font-family:"pf-pixelscript",sans-serif] text-5xl text-center font-bold mb-[8vh]'>About Me</h1> 
            <div className="relative mx-auto w-[45vw] mt-[3vh] pt-[5vh] pb-[10vh] rounded-4xl overflow-hidden">
                <div className="absolute inset-0 bg-white opacity-60"></div>

                <div className="relative z-10">
                    <img src={profileImage} className="mx-auto w-[20vw] h-auto"/>

                    <div className='[font-family:"high1-wonchuri-body",sans-serif] text-[18px] mt-[5vh] mx-[8vw] text-center'>
